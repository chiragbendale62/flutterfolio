...
import 'package:flutterfolio/presentation/pages/about/widgets/about_header.dart';
import 'package:flutterfolio/presentation/pages/about/widgets/technology_section.dart';
...
class _AboutPageState extends State<AboutPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? bodyText2Style = textTheme.bodyLarge?.copyWith(color: AppColors.grey750);
                      ...
                      footer: Column(
                        ...
                        children: [
                          ...
                          AnimatedLineThroughText(
                            ...
                            controller: _contactController,
                            onTap: () {
                              Functions.launchUrlString(StringConst.EMAIL_URL);
                            },
    ...
    for (int index = 0; index < data.length; index++) {
      items.add(
        AnimatedLineThroughText(
          ...
          onTap: () {
            Functions.launchUrlString(data[index].url);
          },
          textStyle: style,
        ),
      );
